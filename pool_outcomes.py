...
POOL_C = {"ENGLAND": 15, "FRANCE": 9, "ARGENTINA": 6, "TONGA": 0, "UNITED STATES": 0}
...
for i in "ABCD":
    ...
    exec("agg_pool_outcomes(pool_score_outcomes(POOL_{}, pool_{}_matches), {}, {})".format(i, i.lower(), trans, -1))
